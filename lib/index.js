...
function subscribe(history, dispatch) {
    ...
    return history.listen(function (newLocation) {
            ...
            for (var _iterator = (0, _getIterator3.default)(rules), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                ...
                if (everyTime || lastLocation === undefined) {
                    ...
                    if (!lastMatch) {
                        ...
                        shouldExec = _diff(match.slice(1), lastMatch.slice(1), _queryString2.default.parse(currentLocation.search), _queryString2.default.parse(lastLocation.search), queries);
                    }
                }
                if (shouldExec) {
                    var queryResult = [];
